  ...
  <form class="meetup-form" @submit.prevent="submit">
    <div class="meetup-form__content">
      ...
      <div class="meetup-form__append">
        <button class="meetup-form__append-button" type="button" data-test="addAgendaItem" @click="createNewAgendaItem">
    ...
    <div class="meetup-form__aside">
      <div class="meetup-form__aside-stick">
        ...
        <ui-button variant="secondary" block class="meetup-form__aside-button" data-test="cancel"
                   @click="$emit('cancel')">Отмена</ui-button>
...
export default {
  ...
  watch: {
    meetup() {
      this.localMeetup = copy(this.meetup)
    }
  },
  ...
  methods: {
    createNewAgendaItem() {
      ...
      const lastAgendaItem = this.localMeetup.agenda.at(-1)
      
      if (lastAgendaItem) newAgendaItem.startsAt = lastAgendaItem.endsAt
